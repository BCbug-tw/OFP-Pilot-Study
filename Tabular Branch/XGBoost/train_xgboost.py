...
def main():
    ...
    # Recombine into DataFrame to preserve feature names for XGBoost
    ...
    plot_loss_from_dict(
        ...
        save_dir=OUTPUT_DIR,
        title='XGBoost Training and Validation Loss'
    )
    ...
    logger.info(f"Saved model to {OUTPUT_DIR}/xgboost_model.json")
