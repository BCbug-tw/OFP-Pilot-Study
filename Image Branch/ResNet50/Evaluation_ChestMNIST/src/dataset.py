...
class ChestMNISTDataset(Dataset):
    def __init__(self, split='train', stage='train', transform=None, img_size=224, max_samples=None):
        ...
        Args:
            ...
            stage (str): 'train' or 'test'. Used to specify the transform stage.
            transform (callable, optional): transforms.
            img_size (int): Image size to retrieve from MedMNIST.
        """
        self.stage = stage
        ...
        # Implement stratified sub-sampling if max_samples is specified
        ...
        if self.use_subsample:
            ...
            try:
                ...
                print("Warning: iterative-stratification not installed. Falling back to random numpy sampling.")
                np.random.seed(42)
